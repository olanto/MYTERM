...
insert into codes values ('msg','msg.seachMessage','Input your search term (%=wildcard)',null);
...
insert into codes values ('sys_field','c.cross_ref', 'visible;4;visible', null);
...
insert into codes values ('sys_field','c.note','hidden;3;hidden',null);
