...
@NamedQueries({
    ...
    @NamedQuery(name = "VjSourcetarget.findBySource", query = "SELECT v FROM VjSourcetarget v WHERE v.source LIKE :source"),
    ...
    @NamedQuery(name = "VjSourcetarget.findConceptPublicBySourceTargetResourceSubjectField", query = "SELECT DISTINCT v.idConcept FROM VjSourcetarget v WHERE v.source LIKE :source AND v.solang = :solang AND v.talang = :talang AND v.idResource IN :selectedValues AND v.subjectField LIKE :subjectField AND v.statusSource like 'p' AND v.statusTarget like 'p'"),
    @NamedQuery(name = "VjSourcetarget.findConceptPublicBySourceTargetResource", query = "SELECT DISTINCT v.idConcept FROM VjSourcetarget v WHERE v.source LIKE :source AND v.solang = :solang AND v.talang = :talang AND v.idResource IN :selectedValues AND v.statusSource like 'p' AND v.statusTarget like 'p'"),
    @NamedQuery(name = "VjSourcetarget.findPublicBySourceResourceSubjectField", query = "SELECT DISTINCT v FROM VjSourcetarget v WHERE v.source LIKE :source AND v.solang = :solang AND v.idResource = :idResource AND v.subjectField LIKE :subjectField AND v.statusSource like 'p' AND v.statusTarget like 'p'"),
    @NamedQuery(name = "VjSourcetarget.findPublicBySourceResource", query = "SELECT DISTINCT v FROM VjSourcetarget v WHERE v.source LIKE :source AND v.solang = :solang AND v.idResource = :idResource AND v.statusSource like 'p' AND v.statusTarget like 'p'"),
    @NamedQuery(name = "VjSourcetarget.findPublicBySourceResourceSubjectFieldConcept", query = "SELECT DISTINCT v FROM VjSourcetarget v WHERE v.source LIKE :source AND v.solang = :solang AND v.idResource = :idResource AND v.subjectField LIKE :subjectField AND v.statusSource like 'p' AND v.statusTarget like 'p' AND v.idConcept = :idConcept"),
    @NamedQuery(name = "VjSourcetarget.findPublicBySourceResourceConcept", query = "SELECT DISTINCT v FROM VjSourcetarget v WHERE v.source LIKE :source AND v.solang = :solang AND v.idResource = :idResource AND v.statusSource like 'p' AND v.statusTarget like 'p' AND v.idConcept = :idConcept"),
    @NamedQuery(name = "VjSourcetarget.findBySource", query = "SELECT v FROM VjSourcetarget v WHERE v.source LIKE :source"),
