...
@NamedQueries({
    ...
    @NamedQuery(name = "VjConceptdetail.findByIdConceptAndLangSetRevision", query = "SELECT v FROM VjConceptdetail v WHERE v.idConcept = :idConcept AND v.idLangset = :idLangset AND v.status LIKE 'r'"),
    @NamedQuery(name = "VjConceptdetail.findByIdConceptAndLangSetWorkspace", query = "SELECT v FROM VjConceptdetail v WHERE v.idConcept = :idConcept AND v.idLangset = :idLangset AND v.status NOT LIKE 'r'"),
