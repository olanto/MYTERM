...
@NamedQueries({
    ...
    @NamedQuery(name = "VjSource.findBySolangResourceStatus", query = "SELECT v FROM VjSource DISTINCT v.idConcept WHERE v.idResource IN :idResource AND v.solang IN :solang AND v.status like :status"),
