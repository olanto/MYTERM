...
@NamedQueries({
    ...
    @NamedQuery(name = "UsersResources.findByOwnerRoles", query = "SELECT u FROM UsersResources u WHERE u.idLink = :idLink AND u.ownerRoles = :ownerRoles"),
    @NamedQuery(name = "UsersResources.findByIdLinkOwnerRoles", query = "SELECT u FROM UsersResources u WHERE u.ownerRoles = :ownerRoles"),
