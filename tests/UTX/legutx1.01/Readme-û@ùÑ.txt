...
Official name:	Japanese-English Standard Dictionary of Legal Terms
Version:	1.01
Language direction:	English to Japanese
License:	Creative Commons 3.0, Attribution No Derivatives (CC-BY-ND)
Author:	Japan (2009)
Name of the website of the original data:	Japanese Law Translation
Original URL:	http://www.japaneselawtranslation.go.jp/?re=02
Converted and distributed by:	AAMT
Distributed at:	http://www.aamt.info/english/utx/
Note:	Some entries are omitted from the original data to avoid inconvenience when used with translation software.

Version history
2009/10/29	1.00	Initial release.
2010/11/23	1.01	Added bidirectional marker, according to the provisional UTX-S 1.10.
...
バージョン：	1.01
言語方向：	英日
ライセンス：	クリエイティブ コモンズ 3.0、表示-改変禁止（CC-BY-ND）
著作権者： 	日本国 (2009)
原典ウェブサイト名：	日本法令外国語訳データベース システム
原典URL：	http://www.japaneselawtranslation.go.jp/
変換・配布者：	AAMT
配布ウェブサイトURL：	http://www.aamt.info/japanese/utx/
注記：	翻訳ソフトで使う際の利便性を考慮し、いくつかの項目はオリジナルのデータから除外されています。
